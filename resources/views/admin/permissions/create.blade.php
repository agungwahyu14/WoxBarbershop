        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Manage user permissions across your system
                </p>
            </div>
        </div>
    </section>
        ...
        <div
            ...
            <div class="card-content rounded-md overflow-x-auto">
                <div class="section main-section">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create Permission</h1>
                    ...
                    <form action="{{ route('permissions.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('permissions.index') }}"
                                class="mr-4 inline-flex items-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-md">
                                Cancel
                            </a>
                            <button type="submit"
