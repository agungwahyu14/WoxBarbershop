...
return [
    ...
    'validation_failed_message' => 'Mohon periksa kembali data yang Anda masukkan.',
    'session_expired' => 'Sesi Berakhir',
    'login_required_message' => 'Silakan login terlebih dahulu untuk melakukan reservasi.',
    'login_now' => 'Login Sekarang',
    'select_this_slot' => 'Pilih Jadwal Ini',
    'close' => 'Tutup',
    'slot_selected' => 'Jadwal Dipilih!',
    'alternative_slot_selected' => 'Jadwal alternatif telah dipilih. Silakan submit ulang formulir.',
    'booking_error_occurred' => 'Terjadi kesalahan saat memproses reservasi.',
    'past_date_not_allowed' => 'Tidak bisa memilih waktu yang sudah berlalu.',
    'view_booking_detail' => 'Lihat Detail Booking',

    // Additional validation messages for validator
    'closed_sunday' => 'Maaf, barbershop tutup pada hari Minggu',
    'choose_weekday' => 'Silakan pilih hari Senin - Sabtu',
    'next_business_day' => 'Hari kerja berikutnya',
    'shop_not_open' => 'Barbershop belum buka',
    'shop_closed' => 'Barbershop sudah tutup',
    'select_time_from' => 'Silakan pilih waktu mulai jam',
    'select_time_before' => 'Silakan pilih waktu sebelum jam',
    'booking_too_far_advance' => 'Booking terlalu jauh di masa depan (maksimal :days hari ke depan)',
    'booking_soon_warning' => 'Booking dalam waktu dekat. Pastikan Anda bisa hadir tepat waktu',
    ...
    'sunday' => 'Minggu',
    'closed' => 'Tutup',
    'select_different_time' => 'Pilih Waktu Lain',
    'attention' => 'Perhatian',
    'booking_valid_note' => 'Booking Anda masih valid, tetapi mohon perhatikan informasi di atas.',
    'understand' => 'Mengerti',

    // Additional missing translations
    'estimated_wait' => 'Estimasi tunggu',
    'minutes' => 'menit',
    'layanan' => 'Layanan',
    'payment_pending' => 'Menunggu Pembayaran',
];
