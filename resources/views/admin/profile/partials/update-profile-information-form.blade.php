    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="flex-1">
                    <input type="file" name="profile_photo" id="admin_profile_photo" accept="image/*" class="hidden"
                        onchange="previewAdminImage(this)">
                    <label for="admin_profile_photo"
    ...
    function previewAdminImage(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                document.getElementById('admin-profile-preview').src = e.target.result;
                Swal.fire({
                    icon: 'success',
