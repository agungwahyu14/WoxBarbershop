        ...
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-10 mt-8">
                <h2 class="text-3xl md:text-4xl font-bold font-playfair text-gray-900">
                    {{ __('transactions.transaction_detail') }}</h2>
                <p class="text-lg text-gray-600 max-w-xl mx-auto mt-2">{{ __('transactions.view_transaction_detail') }}</p>
            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="col-span-full border-b border-gray-200 pb-4 mb-4">
                            <h3 class="text-lg font-semibold text-gray-800 mb-3">
                                <i class="fas fa-user mr-2 text-blue-600"></i> {{ __('transactions.customer_information') }}
                            </h3>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.customer_name') }}
                                    </h4>
                                    <p class="text-lg font-medium text-gray-800">{{ $data['customer_name'] ?? '-' }}</p>
                                </div>
                                <div>
                                    <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.email') }}</h4>
                        ...
                        {{-- Order ID --}}
                        <div>
                            <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.order_id') }}</h4>
                            <p class="text-lg font-semibold text-gray-800">{{ $data['order_id'] }}</p>
                        </div>

                        {{-- Status Pembayaran --}}
                        <div>
                            <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.payment_status') }}</h4>
                            <span
                        ...
                        {{-- Waktu Transaksi --}}
                        <div>
                            <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.transaction_time') }}</h4>
                        ...
                        {{-- Metode Pembayaran --}}
                        <div>
                            <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.payment_method') }}</h4>
                        ...
                        @if (!empty($data['va_number']))
                            <div>
                                <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.bank') }}</h4>
                                <p class="text-lg font-semibold text-gray-800">{{ strtoupper($data['bank']) }}</p>
                            </div>
                            <div>
                                <h4 class="text-sm text-gray-500 uppercase mb-1">{{ __('transactions.virtual_account') }}
                                </h4>
                    ...
                    <div class="pt-6 border-t flex justify-between items-center">
                        <a href="{{ route('payment.index') }}"
                            ...
                            <i class="fas fa-arrow-left mr-2"></i> {{ __('transactions.back') }}
                        </a>
                    </div>
