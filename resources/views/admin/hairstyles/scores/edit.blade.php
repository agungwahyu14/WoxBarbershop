        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div>
                <h1 class="title text-3xl font-bold text-gray-900 dark:text-white flex items-center mb-4">
                    <i class="fas fa-cogs mr-3"></i>Edit Hairstyle Score
                </h1>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">Update existing score for a hairstyle recommendation
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white px-8 py-6 border-b border-gray-200">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Update Score Information</h2>
                        <p class="text-gray-600 mt-1">Modify the score details below</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Card Body -->
            <div class="p-8">
                <form action="{{ route('admin.hairstyles.score.update', $hairstyle_score->id) }}" method="POST"
                    class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-end space-x-4 pt-4">
                        ...
                        <button type="submit"
                            ...
                            <i class="fas fa-save mr-2"></i>Update Score
                        </button>
                    </div>
                </form>
            </div>
