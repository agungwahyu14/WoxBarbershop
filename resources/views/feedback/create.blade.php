    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">Share your experience with our service</p>
            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">{{ $booking->service->name ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500">Date</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $booking->booking_date ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500">Time</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $booking->booking_time ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <h3 class="text-lg font-semibold text-gray-900">Your Feedback</h3>
                </div>
                ...
                <form action="{{ route('feedback.store', $booking) }}" method="POST" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @endfor
                            <span class="ml-3 text-sm text-gray-600 rating-text">Click to rate</span>
                        </div>
                        @error('rating')
