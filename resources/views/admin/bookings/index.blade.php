    ...
    @section('content')
        ...
        <div class=" mx-auto px-6 pt-8  mb-8">
            <!-- Force Tailwind to include these classes: hidden sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-6"
                ...
                <div
                    class="statistics-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-6">
