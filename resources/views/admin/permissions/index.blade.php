    ...
    <section class="section main-section">
        <div
            ...
            <div class="card-content rounded-md overflow-x-auto">
                <table id="permissions-table" class="min-w-full table-fixed divide-y  divide-gray-200 dark:divide-gray-700">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.deleteBtn', function() {
                ...
                const deleteUrl = '{{ route('permissions.destroy', ':id') }}'.replace(':id', permissionId);
